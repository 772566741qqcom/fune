...
import com.d2c.shop.quartz.jobs.WechatJob;
...
public class C_OauthController extends C_BaseController {
    ...
    @ApiOperation(value = "JS-API票据")
    @RequestMapping(value = "/ticket", method = RequestMethod.GET)
    public R ticket() {
        String ticket = String.valueOf(redisTemplate.opsForValue().get(WechatJob.TICKET_KEY + wechatClient.getAppId()));
        return Response.restResult(ticket, ResultCode.SUCCESS);
    }
